...
* Migrate from tsserver to ts_ls (as the former has been deprecated in lspconfig). → [see mason-registry issue](https://github.com/mason-org/mason-registry/issues/7132)
* Prepare promos.
