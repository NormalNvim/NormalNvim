...
* Consider adding a toggle for inserting a breakpoint when clicking on the line number. This might not be wanted by all users, as the clickable area is quite big. For gitsigns is not a big deal because we already have a toggle for it.
