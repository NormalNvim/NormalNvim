...
## Roadmap
* It seems the plugin [treesitter-text-objects](https://github.com/nvim-treesitter/nvim-treesitter-textobjects) is going to be separated from treesitter. So let's keep an eye on that once it's oficially released.
