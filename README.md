...
__You are expected to fork the project before cloning it. So you are the only one in control.__ It is also advised, but not necessary, to use [neovim's appimage](https://github.com/neovim/neovim/releases).
