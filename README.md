...
Inside neovim press `:` to enter a command, and copy paste the next to install all the packages necessary to use `LSP`, `formatters`, `linters`, and the `debugger`. The download is 2Gb so please be patient.
