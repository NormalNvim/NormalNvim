...
## Roadmap
* Once we are dead sure [updater.nvim](https://github.com/Zeioth/distroupdate.nvim) and [heirline-components.nvim](https://github.com/Zeioth/heirline-components.nvim) are stable, let's freeze plugin versions.
