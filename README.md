...
## Roadmap
* Once we are dead sure [distroupdater.nvim](https://github.com/Zeioth/distroupdate.nvim) and [heirline-components.nvim](https://github.com/Zeioth/heirline-components.nvim) are stable, let's freeze plugin versions.
