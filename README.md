...
Inside neovim press `:` to enter a command, and copy paste the next to install `LSP`, `formatters`, `linters`, and the `debuggers` for the 13 most common programming languages. 
...
```
The download is `2GB` so please be patient.
