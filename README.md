...
* ⌨️ **Alternative layout friendly:** Choose between qwerty and colemak-dh mappings. [See wiki](https://github.com/Zeioth/NormalNvim/wiki/colemak). Mouse is fully supported too, as much as neovim allows it.
