...
* **How can I disable the animations?** You can delete the plugin [mini.animate](https://github.com/echasnovski/mini.animate). If you only want to disable some animations. look into the plugin docs.
