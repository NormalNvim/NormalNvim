...
* Consider adding a toggle for interting breakpoint when clicking on the line number. This might not be wanted by all users. For gitsigns is not a big deal because we already have a toggle for it.
