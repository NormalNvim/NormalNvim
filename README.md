...
* Instead of showing every plugin in the readme, show the main ones with a description. That will make easier for people to understand the main features. We can move the details to the wiki.
