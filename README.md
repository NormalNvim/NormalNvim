...
You can preview it [here](https://raw.githubusercontent.com/NormalNvim/installer)
```sh
...
* 🥶 **Plugin version freeze:** You can choose "stable" or "nightly" update channels. Or if you prefer, use :NvimFreezePluginVersions to create your own stable versions!
...
## Roadmap
* News: `NormalNvim v3.7.2` is gonna migrate to the latest version of none-ls. This doesn't bring any new feature, it is just a requirement now that [none-ls is deprecating all builtins that haven't been maintained in the last year](https://github.com/nvimtools/none-ls.nvim/discussions/81). → TODOS: Currently testing everything.
