...
local init = require "base.utils.status.init"
local provider = require "base.utils.status.provider"
...
function M.lsp(opts)
  opts = extend_tbl({
    ...
    surround = { separator = "right", color = "lsp_bg", condition = (condition.lsp_attached or nil) },
    on_click = {
      name = "heirline_lsp",
      callback = function()
