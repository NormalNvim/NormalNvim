--- ### Nvim Status API
--
-- Statusline related utility functions to use within Nvim and user configurations.
--
-- This module can be loaded with `local status = require "base.utils.status"`
--
-- @module base.utils.status
-- @copyright 2022
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("base.utils.status").hl.mode },
...
-- @usage local heirline_component = require("heirline.utils").surround({ "|", "|" }, require("base.utils.status").hl.mode_bg, heirline_component),
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("base.utils.status").hl.get_attributes("treesitter") },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("base.utils.status").hl.file_icon("winbar") },
...
-- @usage local heirline_component = { init = require("base.utils.status").init.breadcrumbs { padding = { left = 1 } } }
...
---@return function # The Heirline init function
-- @usage local heirline_component = { init = require("base.utils.status").init.separated_path { padding = { left = 1 } } }
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.fill }
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.signcolumn }
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.showcmd() }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.scrollbar() }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.filetype() }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.file_icon() }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.git_diff({ type = "added" }) }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.lsp_progress() }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = require("base.utils.status").provider.str({ str = "Hello" }) }
-- @see base.utils.status.utils.stylize
...
-- @usage local heirline_component = { provider = "Example Provider", condition = function() return require("base.utils.status").condition.buffer_matches { buftype = { "terminal" } } end }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.is_macro_recording }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.is_hlsearch }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.git_changed }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.file_modified }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.file_read_only }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.aerial_available }
...
-- @usage local heirline_component = { provider = "Example Provider", condition = require("base.utils.status").condition.treesitter_available }
...
---@param opts? table options for configuring file_icon, filename, filetype, file_modified, file_read_only, and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.cmd_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.git_branch()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.git_diff()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.foldcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.numbercolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("base.utils.status").component.signcolumn()
