...
-- This is automatically loaded and should not be resourced, everything is accessible through the global `base` variable.
--
...
base.default_colorscheme = base.user_opts("colorscheme", "astrotheme", false)
